      ...
      <Link to={`/video/${video?.videoId}`}>
        <div className="flex mb-3 ">
          ...
          <div className="flex flex-col ml-3 overflow-hidden">
            ...
            <span className="text-[12px] lg:text-[10px] xl:text-[12px] font-normal mt-2 flex items-center">
              {video?.author?.title}
              {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" && (
                <BsFillCheckCircleFill className=" text-[12px] lg:text-[10px] xl:text-[12px] ml-1" />
              )}
            </span>
            <div className="flex text-[12px] lg:text-[10px] xl:text-[12px] font-normal truncate overflow-hidden">
